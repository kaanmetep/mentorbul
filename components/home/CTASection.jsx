...
const CTASection = () => {
  return (
    <div className="relative bg-gradient-to-r from-blue-900 to-blue-950 text-white p-10 lg:p-20 rounded-lg flex flex-col items-center overflow-hidden">
      {/* Glow effect */}
      ...
      <p className="text-center text-lg lg:text-xl mt-8 w-full lg:w-[60%] mx-auto font-semibold leading-9 relative z-10">
